            ...
            <div class="col-lg-3">
              <div class="profileDashboard-left">
                ...
                <div class="nav flex-column nav-pills">
                  ...
                  <a class="profile-button active" href="TeacherProfile_Education.php">
                    ...
                    <form action="#" method="post" role="form" class="Dashboard-email-form">
                      <div class="row">
                        ...
                        <div class="form-group col-md-6 mt-3">
                          <label class="form-label" for="Subject">Group or Subject </label>
                          <input type="text" class="form-control" name="Subject" id="Subject" placeholder="Group or Subject " required>
                        </div>
                        <div class="form-group col-md-6 mt-3">
                          <label class="form-label" for="Institute">Institute Name</label>
                          <input type="text" name="Institute" class="form-control" id="Institute" placeholder="Institute Name" required>
                        </div>
                        <div class="form-group col-md-6 mt-3">
                        ...
                        <div class="form-group col-md-6 mt-3">
                          ...
                          <input type="text" name="year" class="form-control" id="year" placeholder="Passing year " required>
                        </div>
                      </div>
                    </form>
                  </div>

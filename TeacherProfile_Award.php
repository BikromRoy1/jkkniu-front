            ...
            <div class="col-lg-3">
              <div class="profileDashboard-left">
                ...
                <div class="nav flex-column nav-pills">
                  ...
                  <a class="profile-button active" href="TeacherProfile_Award.php">
                    ...
                    <form action="#" method="post" role="form" class="Dashboard-email-form">
                      <div class="row">
                        <div class="form-group col-md-6">
                          <label class="form-label" for="Job">Award Title</label>
                          <input type="text" class="form-control" name="Job" id="Job" placeholder="Award Title" required>
                        </div>
                        <div class="form-group col-md-6">
                          <label class="form-label" for="Award">Award Type </label>
                          <input type="text" class="form-control" name="Award" id="Award" placeholder="Award Type " required>
                        </div>
